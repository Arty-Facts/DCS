...
from project.IT_GAN.DiffAugment_pytorch import DiffAugment
import numpy as np
import math
import functools
...
import project.IT_GAN.layers as layers
...
def G_arch(ch=64, attention='64', ksize='333333', dilation='111111'):
    """
    Generate the architecture dictionary for the generator network.

    Args:
        ch (int): The base number of channels.
        attention (str): A string representing the attention layers to include in the architecture.
                         Each digit in the string corresponds to a resolution level, starting from 8x8.
                         A digit of 1 indicates the presence of an attention layer at that resolution level,
                         while a digit of 0 indicates the absence of an attention layer.
        ksize (str): A string representing the kernel sizes for each convolutional layer in the architecture.
                     Each digit in the string corresponds to a resolution level, starting from 8x8.
                     A digit of 3 indicates a kernel size of 3x3, while a digit of 1 indicates a kernel size of 1x1.
        dilation (str): A string representing the dilation rates for each convolutional layer in the architecture.
                        Each digit in the string corresponds to a resolution level, starting from 8x8.
                        A digit of 1 indicates no dilation, while a digit of 2 indicates a dilation rate of 2.

    Returns:
        dict: The architecture dictionary containing the configuration for each resolution level.
              The keys of the dictionary are the resolution levels, and the values are dictionaries
              containing the 'in_channels', 'out_channels', 'upsample', 'resolution', and 'attention' values.
    """
    arch = {}
